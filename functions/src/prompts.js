...
const PROMPTS = Object.freeze({
  ...
  [OPERATIONS.STRUCTURE_LESSON_RECORD]: {
    ...
    task: [
      ...
      "제안 예: '운동을 힘들어했고, 다음 수업에는 리포머로 운동하겠습니다'는 didToday=[], observations=[], responses=['운동을 힘들어함'], nextFocus=['리포머로 운동 진행'], suggestions=[{field:'nextFocus', text:'다음 수업 강도 조절 확인', kind:'content'}]입니다. 강도를 낮췄다는 말이 없으므로 didToday는 비웁니다.",
