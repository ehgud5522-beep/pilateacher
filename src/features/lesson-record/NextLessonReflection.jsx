  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center px-6" role="dialog" aria-modal="true" aria-label="기록 반영 확인"
      ...
      <div className="w-full max-w-sm">
        ...
        {reflection.layout === "C" ? (
          <div className="mt-4 rounded-2xl p-4 text-center" style={{ backgroundColor: "var(--card)" }}>
            ...
            {reflection.repeated && (
              <div className="mt-3 flex items-center gap-2 rounded-xl px-3 py-2 text-left" style={{ backgroundColor: "var(--canvas)" }}>
          ...
          <>
            <div className="mt-4 rounded-2xl p-4" style={{ backgroundColor: "var(--card)" }}>
